            ...
            <div class="row">
              <div class="col-12 col-md-4 col">
                <div class="addressee-info">
                  ...
                  <address itemscope itemprop="address" itemtype="http://schema.org/PostalAddress">
                    <h4 class="name" itemprop="name">Chad Carteret</h4>
                     <span class="street" itemprop="streetAddress">1234 Non-Fake Street</span>
                     <br />
                     <span class="city" itemprop="addressLocality">Mountain View</span>,
                     <span class="state" itemprop="addressRegion">CA</span>
                     <span class="zip" itemprop="postalCode">94043</span>
              ...
              <div class="col-12 col-md-4 col">
                <div class="balance-info">
                  ...
                  <div class="balance-details">
                    <input class="form-control balance-due" type="text" name="balance-due" disabled readonly value="${{ $invoice->amount_due }}" />
            ...
            <div class="row">
              <div class="col-12">
                ...
                <div class="total-detail">
                  <h4 class="title">Balance Due: <span>${{ $invoice->amount_due }}</span></h4>
                </div> <!-- total detail -->
              </div> <!-- col -->
            </div> <!-- row -->
