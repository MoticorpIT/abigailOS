								...
								<h2 class="heading">
									<div class="row">
										<div class="col-12 col-md-6">
											<input type="text" class="form-control {{ $errors->has('first_name') ? 'has-error' : '' }}" name="first_name" value="{{ $tenant->first_name }}" placeholder="First Name">
										</div> <!-- col -->
										<div class="col-12 col-md-6">
											<input type="text" class="form-control {{ $errors->has('last_name') ? 'has-error' : '' }}" name="last_name" value="{{ $tenant->last_name }}" placeholder="Last Name">
										</div> <!-- col -->
									</div> <!-- row -->
								</h2>
							</div>
