              ...
              <div class="row subhead no-gutters">
                ...
                <div class="col-12 col-sm-7 col-md-8 col-lg-9">
                  <h2 class="profile-heading heading">
                    <input type="text" class="form-control {{ $errors->has('name') ? 'has-error' : '' }}" name="name" placeholder="Name" value="{{ $account->name }}" autofocus>
                  </h2>
                </div>
              </div> <!-- row -->
                  ...
                  <div class="tab-content profile-tabs-content" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="phone-tab-content" role="tabpanel" aria-labelledby="phone-tab-button">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <input type="tel" class="form-control {{ $errors->has('phone_1') ? 'has-error' : '' }}" name="phone_1" placeholder="n/a" value="{{ $account->phone_1 }}">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <input type="tel" class="form-control {{ $errors->has('phone_2') ? 'has-error' : '' }}" name="phone_2" placeholder="n/a" value="{{ $account->phone_2 }}">
                          <div class="input-group-append d-none d-lg-block">
                            <div class="input-group-text">
                              <i class="fas fa-phone"></i>
                            </div>
                    ...
                    <div class="tab-pane fade" id="fax-tab-content" role="tabpanel" aria-labelledby="fax-tab-button">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <input type="tel" class="form-control {{ $errors->has('fax') ? 'has-error' : '' }}" name="fax" placeholder="n/a" value="{{ $account->fax }}">
                          <div class="input-group-append d-none d-lg-block">
                            <div class="input-group-text">
                              <i class="fas fa-fax"></i>
                            </div>
                    ...
                    <div class="tab-pane fade" id="email-tab-content" role="tabpanel" aria-labelledby="email-tab-button">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <input type="email" class="form-control {{ $errors->has('email') ? 'has-error' : '' }}" name="email" placeholder="n/a" value="{{ $account->email }}">
                          <div class="input-group-append d-none d-lg-block">
                            <div class="input-group-text">
                              <i class="fas fa-at"></i>
                            </div>
                  ...
                  <div class="row">
                    <div class="col-12 col-md-3 col">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="created-at" value="{{ $account->created_at->format('m/d/y') }}" disabled readonly placeholder="n/a">
                      </div>
                    </div> <!-- col -->
                    <div class="col-12 col-md-3 col">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="updated-at" value="{{ $account->updated_at->format('m/d/y') }}" disabled readonly placeholder="n/a">
                      </div>
                    </div> <!-- col -->
                    <div class="col-12 col-md-3 col">
                      {{-- Account Type --}}
                    ...
                    <div class="col-12 col-md-2 col">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ $errors->has('company_id') ? 'has-error' : '' }}" name="company_id" placeholder="n/a" value="{{ $account->company_id }}">
                      </div>
                    </div> <!-- col -->
                    <div class="col-12 col-md-2 col">
                      {{-- Account Asset ID --}}
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ $errors->has('asset_id') ? 'has-error' : '' }}" name="asset_id" placeholder="n/a" value="{{ $account->asset_id }}">
                      </div>
                    </div> <!-- col -->
                  </div> <!-- row -->
                </div> <!-- col -->
