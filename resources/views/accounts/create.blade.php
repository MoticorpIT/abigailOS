                  ...
                  <div class="row">
                    ...
                    <div class="col-12 col-md-2 col">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ $errors->has('company_id') ? 'has-error' : '' }}" name="company_id" placeholder="#1234" value="{{ old('company_id') }}">
                      </div>
                    </div> <!-- col -->
                    <div class="col-12 col-md-2 col">
                      {{-- Account Asset ID --}}
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control {{ $errors->has('asset_id') ? 'has-error' : '' }}" name="asset_id" placeholder="#5678" value="{{ old('asset_id') }}">
                      </div>
                    </div> <!-- col -->
                  </div> <!-- row -->
                </div> <!-- col -->
