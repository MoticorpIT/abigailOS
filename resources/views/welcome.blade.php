  ...
  <div class="container-fluid main-content">
    <div class="row main-content-row">
      <div class="sidebar">
        <ul class="nav-list">
          <li>
            <span class="heading">Main Nav</span>
          ...
          <li>
            <span class="heading">Secondary Nav</span>
            <ul class="nav-sublist">
              <li>
                <a href="#0">One</a>
              </li>
          ...
          <li>
            <span class="heading">Tertiary Nav</span>
            <ul class="nav-sublist">
              <li>
                <a href="#0">One</a>
              </li>
      ...
      <div class="content">
        ...
        <div class="progress edit-in-progress d-none">
          <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: 100%; border-radius: 0;">
            <span class="message">Edit in progress</span>
          </div>
        </div>
          ...
          <div class="col-6">
            <div class="tasks db-box">
              ...
              <ul class="db-box-list">
                <li class="overdue">
                  <div class="task-link-wrapper">
                    <a href="#0" class="task-link long" data-toggle="modal" data-target="#complete-task-modal">
                      Donec id elit non mi porta gravida at eget metus. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Cras justo odio, dapibus ac facilisis in, egestas eget quam. Sed posuere consectetur est at lobortis.
                    </a>
                    <div class="task-link-dropdown dropdown">
                      <a class="task-link-arrow dropdown-toggle" href="#" id="task-link-dd1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <i class="far fa-circle" data-template='<i class="fas fa-chevron-circle-down"></i>'></i>
                ...
                <li class="warning">
                  <div class="task-link-wrapper">
                    <a href="#0" class="task-link" data-toggle="modal" data-target="#complete-task-modal">
